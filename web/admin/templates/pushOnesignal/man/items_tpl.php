    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Quản lý thông báo đẩy</li>
            </ol>
        </div>
    </div>
</section>
...
<section class="content">
    ...
    <div class="card card-primary card-outline text-sm mb-0">
        <div class="card-header">
            <h3 class="card-title">Danh sách thông báo đẩy</h3>
        </div>
                        ...
                        <?php for($i=0;$i<count($items);$i++) { ?>
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <a href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['name']?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?=THUMBS?>/100x100x1/<?=UPLOAD_SYNC_L.$items[$i]['photo']?>" alt="<?=$items[$i]['name']?>"></a>
                                </td>
                                <td class="align-middle">
                                    <a class="text-dark" href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['name']?>"><?=$items[$i]['name']?></a>
                                </td>
                                <td class="align-middle text-center text-md text-nowrap">
                                    <a class="btn btn-sm bg-gradient-success text-white" id="push-onesignal" data-url="index.php?com=pushOnesignal&act=sync&id=<?=$items[$i]['id']?>" title="Đẩy tin"><i class="fas fa-paper-plane mr-2"></i>Đẩy tin</a>
                                </td>
                                <td class="align-middle text-center text-md text-nowrap">
