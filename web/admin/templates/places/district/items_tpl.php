<?php
	$linkMan = $linkFilter = "index.php?com=places&act=man_district&p=".$curPage;
    $linkAdd = "index.php?com=places&act=add_district&p=".$curPage;
	$linkEdit = "index.php?com=places&act=edit_district&p=".$curPage;
	$linkDelete = "index.php?com=places&act=delete_district&p=".$curPage;
?>
<!-- Content Header -->
    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Quản lý quận huyên</li>
            </ol>
        </div>
    </div>
</section>
                    ...
                    <tbody>
                        <?php for($i=0;$i<count($items);$i++) {
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <input type="number" class="form-control form-control-mini m-auto update-stt" min="0" value="<?=$items[$i]['stt']?>" data-id="<?=$items[$i]['id']?>" data-table="district">
                                </td>
                                <td class="align-middle">
                                ...
                                <td class="align-middle text-center">
                                	<div class="custom-control custom-checkbox my-checkbox">
                                        <input type="checkbox" class="custom-control-input show-checkbox" id="show-checkbox-<?=$items[$i]['id']?>" data-table="district" data-id="<?=$items[$i]['id']?>" data-loai="hienthi" <?=($items[$i]['hienthi'])?'checked':''?>>
