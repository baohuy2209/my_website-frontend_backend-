...
const BlockUser_1 = __importDefault(require("./Block/BlockUser"));
const dataUser = {
...
class Management_User {
    constructor(difficulty) {
        ...
        const genesisBlock = new BlockUser_1.default(hashBank, dataUser);
    ...
    addBlock(data) {
        ...
        const newBlock = new BlockUser_1.default(lastBlock.getHash(), data);
