  ...
  return (
    <div className="App">
      <div id="wrapper">
        ...
        <div>
          <p>
            ReactJS collapsible accordion component, Light, simple and
            functional. Allows expand and collapse html content. Ready for use
        ...
        <div style={{ marginTop: "100px" }}>
          ...
          <CollapsibleComponent name="second">
            ...
            <CollapsibleContent>
              <p>
                11111 Lorem ipsum dolor sit amet, consectetur adipiscing elit,
            ...
            <CollapsibleHead showContentAboveButton={true} isExpanded={true}>
              Head title 2
            </CollapsibleHead>{" "}
            <CollapsibleContent>
